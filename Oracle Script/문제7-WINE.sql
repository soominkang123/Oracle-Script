create table sale30(
     sale_date date default sysdate not null constraint pk_sale30_date primary key,
     wine_code varchar2(6)
     not null, constraint FK_SALE30_WINE_CODE foreign key(wine_code)references wine30(wine_code),
     mem_id varchar2(30)
     not null, constraint FK_SALE30_MEM_ID foreign key(mem_id)references sale30(mem_id),
...
create table member30(
      ...
      constraint FK_MEMBER30_MEM_GRADE foreign key(mem_grade)references grade_pt_rade40(mem_grade), 
...
create table wine30(
   ...
   constraint FK_WINE30_WINE_TYPE_CODE foreign key (nation_code) references nation30 (nation_code), 
